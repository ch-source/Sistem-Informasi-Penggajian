      ...
      <section class="content">
        <div class="box box-info">
          <div class="box-header with-border">
            <h3 class="box-title">Hasil Rekapitulasi Tunjangan Wali Kelas</h3>
          </div>
          <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Hasil Rekapitulasi Tunjangan Wali Kelas</th>
                </tr>
                </thead>
                <tbody>
                  <?php
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <tbody>
                      <?php
                        $nob=1;
                        $query_q="SELECT * FROM tbl_rekap_kt WHERE id_pegawai='".$data_user['id_pegawai']."'";
                        $sql_q=mysqli_query($connect, $query_q);
                        while ($data_q=mysqli_fetch_array($sql_q)) {
                        ?>
                      <tr class="info">
                        <td><?php echo $nob;?></td>
                        <td><?php echo $data_q['periode_rkt'];?>/<?php echo $data_q['tahun_rkt'];?></td>
                        <td>
                          <?php 
                          $jml= $data_q['jml_kt'];
          ...
          <div class="box-footer">
            <a href="dashboard_guru.php?p=data_kelas_tambahan" class="btn btn-default"><i class="fa fa-close"></i> Tutup</a>
          </div>
        </div>
      </section>