...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="dashboard_kepsek.php" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="dashboard_kepsek.php?p=laporan_terlambat"><i class="fa fa-circle-o"></i> Keterlambatan</a></li>
            <li><a href="dashboard_kepsek.php?p=laporan_tunjangan"><i class="fa fa-circle-o"></i> Laporan Tunjangan Jabatan</a></li>
            <li><a href="dashboard_kepsek.php?p=laporan_tunjangan_wk"><i class="fa fa-circle-o"></i> Laporan Tunjangan Wali Kelas</a></li>
            <li><a href="dashboard_kepsek.php?p=laporan_gaji"><i class="fa fa-circle-o"></i> Laporan Rekap Gaji</a></li>
          </ul>
        </li>
      </ul>
    </section>
