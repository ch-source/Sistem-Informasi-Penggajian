...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="dashboard_pegawai.php" class="logo">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu" data-widget="tree">
        <li class="active">
          <a href="dashboard_pegawai.php">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
          </a>
        </li>
         <li>
          <a href="dashboard_pegawai.php?p=data_absesnsi">
            <i class="fa fa-calendar-check-o"></i> <span> Data Absensi Saya</span>
          </a>
        </li>
         <li>
          <a href="dashboard_pegawai.php?p=data_tunjangan">
            <i class="fa fa-calendar-plus-o"></i> <span> Data Tunjangan</span>
          </a>
        </li>
         <li>
          <a href="dashboard_pegawai.php?p=data_potongan">
            <i class="fa fa-calendar"></i> <span> Data Potongan</span>
          </a>
        </li>
        <li>
          <a href="dashboard_pegawai.php?p=data_gaji">
